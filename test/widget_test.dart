...
void main() {
  testWidgets('App boot smoke test — root widget renders without exception', (
    ...
    // We do not pump the full OrdersDesktopApp because that requires live
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(body: Center(child: Text('OrderS Desktop'))),
      ),
    );

    expect(find.text('OrderS Desktop'), findsOneWidget);
  });
}
