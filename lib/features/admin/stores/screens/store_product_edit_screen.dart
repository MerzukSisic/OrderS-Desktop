...
class _StoreProductEditScreenState extends State<StoreProductEditScreen> {
  ...
  void initState() {
    ...
    _purchasePriceController = TextEditingController(text: widget.product.purchasePrice.toStringAsFixed(2));
    _currentStockController = TextEditingController(text: widget.product.currentStock.toString());
  ...
  Future<void> _handleSave() async {
    ...
    try {
      final success = await context.read<InventoryProvider>().updateStoreProduct(
        widget.product.id,
