...
import 'package:rs2_desktop/features/admin/orders/screens/orders_list_screen.dart';
...
class _AdminLayoutScreenState extends State<AdminLayoutScreen> {
  ...
  final List<Widget> _screens = [
    ...
    const OrdersListScreen(), // 5
    const UsersListScreen(), // 6
    const StatisticsScreen(), // 7
    const TablesListScreen(), // 8
    const StoresListScreen(), // 9
  ];
              ...
              return Stack(
                children: [
                  IconButton(
                    ...
                    onPressed: () =>
                        _showNotificationsDialog(context, notifProvider),
                  ),
