...
class ProcurementApiService {
  ...
  /// Returns full PaymentIntentResponseDto: {paymentIntentId, clientSecret, amount, currency, status}
/// Create payment intent for procurement
Future<ApiResponse<Map<String, dynamic>>> createPaymentIntent(String procurementOrderId) {
